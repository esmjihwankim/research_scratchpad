...
class UrbanSoundDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.device = device
        self.transformation = transformation.to(device) # the transformation will be using gpu or cpu
    ...
    def _get_audio_sample_label(self, index): # join fold, audio directory and file name
